...
struct move_data moves[] = {
...

   {
    ...
    .category = MOVE_SPECIAL,
    .type = MTYPE_FLYING,
    .m_flags = FLAG_SOUND | FLAG_AUTHENTIC | FLAG_PROTECT | FLAG_TARGET,
    .procs = &supersonic_procs,
    },
    ...
    .category = MOVE_PHYSICAL,
    .type = MTYPE_WATER,
    .m_flags = FLAG_PULSE | FLAG_MIRROR | FLAG_PROTECT | FLAG_HITS_ADJACENT,
    .procs = &basic_proc,
    },
    ...
    .category = MOVE_SPECIAL,
    .type = MTYPE_WATER,
    .m_flags = FLAG_SOUND | FLAG_AUTHENTIC | FLAG_MIRROR | FLAG_PROTECT | FLAG_HITS_ADJACENT,
    .procs = &basic_proc,
    .on_effect_cb = sparkling_aria_on_effect,
    },
    ...
    .m_flags = FLAG_DANCE | FLAG_MIRROR | FLAG_PROTECT | FLAG_TARGET,
    .procs = &basic_proc,
    .on_modify_move = revelation_dance_on_modify_move,
    },
