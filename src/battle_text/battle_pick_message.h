...
static const pchar str_fled[] = _("Got away safely.");
static const pchar str_flee_failed[] = _("Could not flee!");
...
static const pchar* battle_strings[80] = {
